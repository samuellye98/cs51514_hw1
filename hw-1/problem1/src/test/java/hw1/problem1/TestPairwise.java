 ...
 * The following characteristics have been identified and are used to generate tests for the methods:
 ...
 To ensure pair-wise coverage while satisfying the constraint of our partitions,
 we consider the following test cases:
     B1, C1, R1 // B1-C1, B1-R1, C1-R1
     B2, C1, R1 // B2-C1, B2-R1
     B3, C1, R1 // B3-C1, B3-R1

     B1, C2, R1 // B1-C2, C2-R1
     B2, C2, R1 // B2-C2
     B3, C2, R1 // B3-C2

     B1, C3, R1 // B1-C3, C3-R1
     B2, C3, R1 // B2-C3
     B3, C3, R1 // B3-C3

     B3, C3, R2 // B3-R2, C3-R2
     B3, C3, R3 // B3-R3, C3-R3
 */
